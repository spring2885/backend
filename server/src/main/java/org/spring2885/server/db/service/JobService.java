...
public interface JobService {
     ...
     */
    Iterable<DbJob> findAll(DbPerson me, boolean all, String q);

    /**
     * Returns all non-deleted and non-abuse {@code DbNews} instances.
     */
    Iterable<DbJob> findAll(DbPerson me, boolean all);
    
	/**
     * Returns all {@code DbNews} instances with search string {code q}.
     */
    Iterable<DbJob> findAll(DbPerson me, boolean all, List<SearchCriteria> criterias);
